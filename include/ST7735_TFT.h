...
#define TFT_CS_SetHigh digitalWrite(_TFT_CS, HIGH) // SW SPI last 6 lines
...
#define TFT_SCLK_SetDigitalOutput pinMode(_TFT_SCLK, OUTPUT) // SW SPI last 3 lines
#define TFT_SDATA_SetDigitalOutput pinMode(_TFT_SDATA, OUTPUT)
#define TFT_CS_SetDigitalOutput pinMode(_TFT_CS, OUTPUT)

#define TFT_HIGHFREQ_DELAY 1 //Software SPI delay
